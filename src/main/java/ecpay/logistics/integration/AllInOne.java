...
public class AllInOne extends AllInOneBase {
    private final static Logger log = LoggerFactory.getLogger(AllInOne.class);

    public AllInOne(String logPath) {
        System.setProperty("org.slf4j.simpleLogger.defaultLogLevel", "OFF");
        if (logPath != null && !logPath.isEmpty()) {
            System.setProperty("org.slf4j.simpleLogger.logFile", logPath);
            System.setProperty("org.slf4j.simpleLogger.showDateTime", "true");
            System.setProperty("org.slf4j.simpleLogger.dateTimeFormat", "yyyy-MM-dd HH:mm:ss");
            System.setProperty("org.slf4j.simpleLogger.log.ecpay", "INFO");
        }
    }
